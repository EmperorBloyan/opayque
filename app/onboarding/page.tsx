    ...
    try {
      ...
      if (!signInError && signInData.user) {
        ...
        if (!signUpData.session) {
          setErrorMessage(
            "Account created. Check your email and confirm your address before continuing setup."
          );
          return;
        }
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-xs text-zinc-400">
                Connect wallet, sign ownership, create your account, then initialize the gasless vault.
              </p>
              {setupNotice && (
            ...
            <div className="space-y-4">
                      ...
                      {connected ? (
                        <div className="flex flex-col gap-2">
                          <span className="truncate text-sm text-white">
                            {walletAddress || publicKey?.toBase58() || "Wallet connected"}
                          </span>
                          <div className="flex flex-wrap gap-2">
                            ...
                            >
                              ...
                              {isInitVault ? "Initializing..." : vaultReady ? "Vault ready" : "Initialize Vault (gasless)"}
                            </button>
                          </div>
                        </div>
                      ) : (
              ...
              <div className="mb-1 flex flex-col gap-1 text-[10px] uppercase tracking-[0.2em] text-zinc-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {walletSigned ? "Settlement wallet signed and verified" : "Wallet must be connected and signed"}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  {vaultReady ? (
                  ...
                  <span>
                    {vaultReady ? "Secured vault initialized (gasless)" : "Vault will be initialized after account creation"}
                  </span>
                </div>
              </div>
